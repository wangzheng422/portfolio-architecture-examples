...
Use case: Patching SAP hosts at OS, DB and SAP kernel level with no service interruption for the users
...
--
image:logical-diagrams/nzd-maintenance-sap.png[350, 300]
image:schematic-diagrams/nzd-maintenance-sap-network-sd.png[350, 300]
image:schematic-diagrams/nzd-maintenance-sap-data-sd.png[350, 300]
