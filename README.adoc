...
|link:edge.adoc[Edge]
|This is a *collection of various architectures* featuring edge computing. Customers are increasing looking to edge
...
|This is a *collection of various architectures* in the manufacturing domain. The manufacturing industry has
consistently used technology to fuel innovation, production optimization and operations. Now, with the combination of
edge computing and AI/ML, manufacturers can benefit from bringing processing power closer to data. This helps actions
be taken faster on things like errors and predictive maintenance.
