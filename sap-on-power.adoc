...
All products are shown in the technology capture below.
...
_Figure 4. Schematic diagram of the architecture._
...
== Provide feedback 
You can offer to help correct or enhance this architecture by filing an https://gitlab.com/osspa/portfolio-architecture-examples/-/issues[issue or submitting a merge request against this Portfolio Architecture product in our GitLab repositories].
