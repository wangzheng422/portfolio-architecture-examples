...
image::./images/intro-marketectures/sap-on-ibm-power-solution-overview.png[solution overview]

[alt="RHEL for SAP workloads on IBM Power, PowerVC, Smart Management, Automation Platform and Red Hat Insights SaaS", width=700]
