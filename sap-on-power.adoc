...
--
image:https://gitlab.com/mschindl1/portfolio-architecture-examples-sap/-/blob/sap-on-power/images/intro-marketectures/sap-on-ibm-power-solution-overview.png[alt="RHEL servers hosting SAP workloads on IBM Power hardware, PowerVC, RHEL with Red Hat Smart Management, Red Hat Automation Platform on premise and Red Hat Insights SaaS", width=700]
--
