...
Use case 1 (Equipement manufactures): Enabling ultra-reliable, immersive telco experiences through 5G for people and objects when and where it matters most. These diagrams is how a network equipment manufactures can create a solution for 5G Core network.
...
Use case 2 (Public Cloud): Enabling ultra-reliable, immersive telco experiences through 5G for people and objects when and where it matters most. These diagrams is how public cloud services can be create a solution for 5G Core network.

--
https://redhatdemocentral.gitlab.io/portfolio-architecture-tooling/index.html?#/portfolio-architecture-examples/projects/Telco5GC-Generic-2.drawio[[Load Diagram]]
--
