...
--
https://redhatdemocentral.gitlab.io/portfolio-architecture-tooling/index.html?#/portfolio-architecture-examples/projects/retail-cloud-adoption.drawio[[Load Diagram]]
https://gitlab.com/redhatdemocentral/portfolio-architecture-examples/-/raw/main/diagrams/retail-cloud-adoption.drawio?inline=false[[Download Diagram]]
--

--
image:logical-diagrams/logical-cloud-adoption.png[350, 300]
image:schematic-diagrams/schematic-network-cloud-adoption.png[350, 300]
image:schematic-diagrams/schematic-dataflow-cloud-adoption.png[350, 300]
--
