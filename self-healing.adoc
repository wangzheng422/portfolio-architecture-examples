...
== Logical diagram
image:https://gitlab.com/osspa/portfolio-architecture-examples/-/raw/main/images/logical-diagrams/self-healing-ld-withSatellite.png[alt="A self healing architecture consists of automation orchestration, smart system management, and your managed infrastructure", width=700]
