...
image:https://gitlab.com/osspa/portfolio-architecture-examples/-/raw/main/images/intro-marketectures/lossmanagement-marketing-slide.png[alt="solution overview", width=700]

_Figure 1: Overview of the loss management solution._
...
The architectures seen in Figures 3 and 4 embody the following principles:
...
image:https://gitlab.com/osspa/portfolio-architecture-examples/-/raw/main/images/schematic-diagrams/lossmanagement-environmentexception-sd.png[alt="environmental exception schematic", width=700]

_Figure 3. Schematic for environment exception._
...
Figure 4 shows the schematic for the contamination recall
use case.

image:https://gitlab.com/osspa/portfolio-architecture-examples/-/raw/main/images/schematic-diagrams/lossmanagement-recall-sd.png[alt="recall schematic", width=700]

_Figure 4, Schematic for environment exception._
...
Red Hat OpenShift enables DevOps, an approach to culture, automation and platform
...
Ansible Automation Platform*] operates, scales, delegates, and automates IT
services, tracks changes and updates inventory, and prevents configuration drift.
It can be integrated with ITSM. https://www.redhat.com/en/technologies/management/ansible/trial?intcmp=7013a000003Sh3TAAS[*Try It >*]
...
application development platform is defining the standards for development, deployment, and
...
== Provide feedback
You can offer to help correct or enhance this architecture by filing an https://gitlab.com/osspa/portfolio-architecture-examples/-/blob/main/lossmanagement.adoc[issue or submitting a merge request against this architecture product in our GitLab repositories].
