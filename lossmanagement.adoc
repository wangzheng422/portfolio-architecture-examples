...
image::./images/schematic-diagrams/lossmanagement-environmentexception-sd.svg[environmental exception schematic]
...
image::./images/schematic-diagrams/lossmanagement-recall-sd.svg[recall schematic]
