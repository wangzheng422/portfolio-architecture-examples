...
For more information about the solution details in this scenario, see https://www.redhat.com/architect/portfolio/detail/36[Demand risk]
...
* https://www.redhat.com/architect/portfolio/detail/36[Demand risk]
* Loss and waste management (coming soon)
* Product timeliness  (coming soon)
* Perfect order (coming soon)
* Intelligent order (coming soon)
