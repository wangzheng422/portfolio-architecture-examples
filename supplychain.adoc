...
--
https://www.redhat.com/architect/portfolio/tool/index.html?#gitlab.com/osspa/portfolio-architecture-examples/-/raw/main/diagrams/SupplyChainOptimization.drawio[[Open Diagrams]]
--
