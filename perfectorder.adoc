...
image::./images/logical-diagrams/inventoryoptimisation-ld.png[alt="Logical view", width=700]
...
* https://www.ibm.com/products/inventory-visibility[*IBM Sterling Inventory
