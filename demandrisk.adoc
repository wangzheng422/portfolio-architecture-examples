= Demand Risk in Supply Chains Portfolio Architecture
...
Figure 2 shows the schematic for the understock use case.

image::./images/schematic-diagrams/demandrisk-understock-sd.png[understock schematic]
_Figure 2. Schematic diagram of understock use case._
...
Figure 3 shows the schematic for the overstock use case.

image::./images/schematic-diagrams/demandrisk-overstock-sd.png[overstock schematic]
_Figure 3. Schematic diagram for the overstock use case._
