...
--
image:https://gitlab.com/redhatdemocentral/portfolio-architecture-examples/-/raw/sap-integration/images/schematic-diagrams/sap-integration-retrieve-data.png[750, 700]
--


== Utilize cached data from SAP for BI use case
--
image:https://gitlab.com/redhatdemocentral/portfolio-architecture-examples/-/raw/sap-integration/images/schematic-diagrams/sap-integration-cached-data.png[750, 700]

== Download diagrams
View and download all of the diagrams above in our open source tooling site.
--
https://redhatdemocentral.gitlab.io/portfolio-architecture-tooling/index.html?#/portfolio-architecture-examples/projects/sap-integration.drawio[[Open Diagrams]]
--
